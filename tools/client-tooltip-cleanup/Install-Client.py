"""Install only the reviewed Hero Advancement tooltip cleanup. Close WoW first."""
...
def main():
    ...
    if not pending:
        print('TOOLTIP CLEANUP ALREADY INSTALLED. No changes.');return
    ...
    print('TOOLTIP CLEANUP COMPLETE. Metadata and controls are in Shift details; sentence spacing updated.')
    print('Backup:',backup)
