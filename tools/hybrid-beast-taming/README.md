...
The initial completion guard incorrectly checked channel ID 1515. Exported PTR Spell.dbc confirms 1515 triggers 13481, whose effect 55 creates the pet. The corrected guard is compiled and active; entitlement still requires learned 1515. Owner verified successful beast taming after the trigger correction. Owner also confirmed the follow-up dismiss/call, relog and stable persistence tests.
