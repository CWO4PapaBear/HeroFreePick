...
function A.Refresh(resetScroll)
 ...
 if (A.tooltipQuery or ''):find('%S') and A.view~='architect'then toolbar:Hide();spellsPanel:Hide();talentsPanel:Hide();architect:Hide();allPanel:Show();local results=A.AdvancementSearchResults();allTitle:SetText('Search - Abilities and Talents ('..#results..')');renderSearchIcons(results)
