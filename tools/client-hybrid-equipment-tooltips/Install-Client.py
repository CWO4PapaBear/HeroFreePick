"""Install only the reviewed Hybrid equipment tooltip correction. Close WoW first."""
...
def main():
    ...
    if not pending:
        print('HYBRID EQUIPMENT TOOLTIPS ALREADY INSTALLED. No changes.');return
    ...
    print('HYBRID EQUIPMENT TOOLTIPS COMPLETE. Confirmed second-class equipment requirements display as satisfied.')
    print('Backup:',backup)
