"""Install only the reviewed Hero Advancement server spell tooltip resolution. Close WoW first."""
...
def main():
    ...
    if not pending:
        print('SERVER TOOLTIP RESOLUTION ALREADY INSTALLED. No changes.');return
    ...
    print('SERVER TOOLTIP RESOLUTION COMPLETE. Server-derived values installed; unresolved descriptions remain yellow.')
    print('Backup:',backup)
