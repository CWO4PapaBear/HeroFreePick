"""Install only the reviewed Hero Advancement blue tooltip values. Close WoW first."""
...
def main():
    ...
    if not pending:
        print('BLUE TOOLTIP VALUES ALREADY INSTALLED. No changes.');return
    ...
    print('BLUE TOOLTIP VALUES COMPLETE. Resolved values are light blue; unresolved warnings remain yellow.')
    print('Backup:',backup)
